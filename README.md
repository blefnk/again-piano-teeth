...
- **🚀 Live Demo**: [again-piano-teeth.vercel.app](https://again-piano-teeth.vercel.app/en)
- **💙 Discord**: [discord.gg/Pb8uKbwpsJ](https://discord.gg/Pb8uKbwpsJ)
- **📚 Docs**: [docs.reliverse.org](https://docs.reliverse.org/again-piano-teeth)
...
1. `git clone https://github.com/blefnk/again-piano-teeth.git`
2. `cd again-piano-teeth`
3. `bun i`
